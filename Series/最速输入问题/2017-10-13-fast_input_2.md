...
author: Aster
type: post
date: 2017-10-13T11:54:27+00:00
url: /2017/10/fast_input_2/
featured_image: /wp-content/uploads/2017/10/fastinput_3-100x100.png
page_preloader:
  - 'false'
theme_header_style:
  - "1"
...
<pre class="lang:mathematica decode:true " title="EDSV 代价函数">cost[i_]:=Block[
	{P=1,D=1,S=2,V=1,l},
	l=Drop[Divisors[i],-1];
	Join[
...
<pre class="lang:mathematica decode:true">n=100;
...
Export["FastInput_3.png",G,Background->None,"CompressionLevel"->100];</pre>

<img class="size-full wp-image-869 aligncenter" src="../wp-content/uploads/2017/10/fastinput_3.png" alt="" width="640" height="639" /> 
...
<pre class="lang:mathematica decode:true ">dp[1]=1;
dp[i_]:=dp[i]=With[
...
Export["FastInput_4.png",pic4,Background->None,"CompressionLevel"-</pre>

可以看到加入删除操作后在不少点有一定的提升.

总体增长速度下降到了 $4.30628\log n$

<img class="size-full wp-image-870 aligncenter" src="../wp-content/uploads/2017/10/fastinput_4.png" alt="" width="1380" height="335" /> 
